...
const NewActivityGame = ({ opponent, setOpponent, title, setTitle, location, setLocation, date, setDate, invitations, setInvitations, additionalInfo, setAdditionalInfo, privateNotes, setPrivateNotes }) => {
